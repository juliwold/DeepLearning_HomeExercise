...
```{r}
plot_preds_on_site <- function(preds, refs, site, ortho) {
    ortho <-
    ...
    tm_shape(refs_on_site) +
        tm_borders(col = "red") +  # TODO: Adjust colors.
    tm_shape(preds_on_site) +
        tm_borders(col = "blue")  # TODO: Adjust colors.
}
```
...
```{r}
# TODO: Plot predictions for both models(A & B).
```
